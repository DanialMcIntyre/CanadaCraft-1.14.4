...
public class CanadaPressurePlate extends AbstractPressurePlateBlock {

	public static final BooleanProperty POWERED = BlockStateProperties.POWERED;
	public final CanadaPressurePlate.Sensitivity sensitivity;

	public CanadaPressurePlate(CanadaPressurePlate.Sensitivity p_i48348_1_, Block.Properties p_i48348_2_) {
	...
	public int getRedstoneStrength(BlockState state) {

		return state.get(POWERED) ? 15 : 0;

	}

	public BlockState setRedstoneStrength(BlockState state, int strength) {

		return state.with(POWERED, Boolean.valueOf(strength > 0));

	}

	public void playClickOnSound(IWorld worldIn, BlockPos pos) {
	...
	public void playClickOffSound(IWorld worldIn, BlockPos pos) {
