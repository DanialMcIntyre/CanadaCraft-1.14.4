...
public class MapleBossBlock extends Block {
		   
	public MapleBossBlock(Properties properties) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
		...
		for(int i = 0; i < 3; i++) {
			...
			Entity maplemonsterentity = CanadaEntities.MAPLE_MONSTER.create(worldIn);
		...
		Entity maplebossentity = CanadaEntities.MAPLE_BOSS.create(worldIn);
