...
public class MapleForest extends Biome {
	...
	public MapleForest() {
		...
		super((new Biome.Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.STONE.getDefaultState(), Blocks.CLAY.getDefaultState()))).precipitation(RainType.RAIN).category(Category.FOREST).depth(0.1F).temperature(0.5F).waterColor(0xfcb603).waterFogColor(0xa1ebed).scale(0.2F).parent((String) null).downfall(0.1F));
		...
		this.setRegistryName(Main.location("maple_forest"));
