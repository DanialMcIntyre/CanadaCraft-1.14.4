...
public class CanadaChunkGenerator extends NoiseChunkGenerator<CanadaGenSettings> {
	...
	public CanadaChunkGenerator(IWorld world, BiomeProvider provider, CanadaGenSettings settingsIn) {
