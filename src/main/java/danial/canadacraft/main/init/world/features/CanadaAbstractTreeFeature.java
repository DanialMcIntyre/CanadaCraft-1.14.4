...
public abstract class CanadaAbstractTreeFeature<T extends IFeatureConfig> extends Feature<T> {
	...
	public CanadaAbstractTreeFeature(Function<Dynamic<?>, ? extends T> p_i49920_1_, boolean doBlockNofityOnPlace) {
	...
	public static boolean func_214587_a(IWorldGenerationBaseReader p_214587_0_, BlockPos p_214587_1_) {
	...
	public static boolean isDirt(IWorldGenerationBaseReader worldIn, BlockPos pos) {
	...
	public static boolean isSoil(IWorldGenerationBaseReader reader, BlockPos pos, net.minecraftforge.common.IPlantable sapling) {
	...
	public static boolean isSoilOrFarm(IWorldGenerationBaseReader reader, BlockPos pos, net.minecraftforge.common.IPlantable sapling) {
	...
	@Deprecated
	public void func_214584_a(IWorldGenerationReader p_214584_1_, BlockPos p_214584_2_) {
	...
	public void setDirtAt(IWorldGenerationReader reader, BlockPos pos, BlockPos origin) {
	...
	public final void setLogState(Set<BlockPos> changedBlocks, IWorldWriter worldIn, BlockPos pos, BlockState p_208520_4_, MutableBoundingBox p_208520_5_) {
	...
	public abstract boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos position, MutableBoundingBox p_208519_5_);
	...
	public CanadaAbstractTreeFeature<T> setSapling(net.minecraftforge.common.IPlantable sapling) {
