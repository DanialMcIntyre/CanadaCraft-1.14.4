...
public class VillagerHutStructure extends Structure<NoFeatureConfig> {
	
	public VillagerHutStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
	...
	public Structure.IStartFactory getStartFactory() {
		...
		return VillagerHutStructure.Start::new;
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			...
			VillagerHutPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

			this.recalculateStructureSize();
			Main.LOGGER.log(Level.DEBUG, "Villager hut at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
