...
public class RockyHouseStructure extends Structure<NoFeatureConfig> {
	
	public RockyHouseStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
	...
	public Structure.IStartFactory getStartFactory() {
		...
		return RockyHouseStructure.Start::new;
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			...
			RockyHousePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

			this.recalculateStructureSize();
			Main.LOGGER.log(Level.DEBUG, "House at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
