...
public class BossRoomStructure extends Structure<NoFeatureConfig> {
	
	public BossRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
	...
	public Structure.IStartFactory getStartFactory() {
		...
		return BossRoomStructure.Start::new;
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			...
			BossRoomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

			this.recalculateStructureSize();
			Main.LOGGER.log(Level.DEBUG, "Boss room at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
