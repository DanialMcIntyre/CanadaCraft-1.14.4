...
public class MapleDungeonStructure extends Structure<NoFeatureConfig> {
	
	public MapleDungeonStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
	...
	public String getStructureName() {
		...
		return Main.MODID + ":mapledungeon";
	...
	public Structure.IStartFactory getStartFactory() {
		...
		return MapleDungeonStructure.Start::new;
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			...
			MapleDungeonPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

			this.recalculateStructureSize();
			Main.LOGGER.log(Level.DEBUG, "Maple Dungeon at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
