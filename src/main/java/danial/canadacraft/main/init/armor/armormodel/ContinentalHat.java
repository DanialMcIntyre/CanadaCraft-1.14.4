...
public class ContinentalHat extends ArmorBuff {
	
	public ContinentalHat(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
	...
	public <ArmorModel extends BipedModel<?>> ArmorModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, ArmorModel _default) {
        ...
        ContinentalHatModel model = new ContinentalHatModel();
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
		...
		return "canadacraft:textures/models/armor/continental_hat_model.png";
